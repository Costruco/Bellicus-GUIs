		...
		if(escolha == MENU_PLAY){
			...
			while (gamerunning && apprunning) {
				...
				if (espera == 0) {
					...
					SDL_FPoint centro_metra_relativo = rotacionar(zero,escalonar(metra_offset,zoom),angulo);
